      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className="font-medium transition-colors text-gray-700 hover:text-red-500"
            >
              Home
            </Link>
            <Link
              to="/search"
              className="font-medium transition-colors flex items-center space-x-1 text-gray-700 hover:text-red-500"
            >
